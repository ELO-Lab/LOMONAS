...
def arch_int_2_representation(arch_int):
    representation = f'|{OPS_LIST[arch_int[0]]}~0|+' \
                     f'|{OPS_LIST[arch_int[1]]}~0|{OPS_LIST[arch_int[2]]}~1|+' \
                     f'|{OPS_LIST[arch_int[3]]}~0|{OPS_LIST[arch_int[4]]}~1|{OPS_LIST[arch_int[5]]}~2|'
...
def get_hashKey(arch_int):
    representation = arch_int_2_representation(arch_int)
    model_hash = topology_str2structure(representation).to_unique_str(consider_zero=True)
    return model_hash